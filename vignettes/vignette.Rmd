...
Here `fukushima17_INC` is a metabolite list and contains 37 significantly increased metabolites including primary and secondary metabolites, mainly flavonols and anthocyanins that are obtained under mild oxidative stress- and control conditions [10]. Both KEGG and KNApSAcK IDs can be used for MSEA.
