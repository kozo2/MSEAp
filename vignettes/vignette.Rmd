...
biocLite(c("KEGGREST", "KEGGgraph", "paxtoolsr"))
...
The function `read.wikipathways()` can extract compound sets from [Wikipathways](https://wikipathways.org/) [BioPAX](www.biopax.org/) file to the metabolite-sets:
