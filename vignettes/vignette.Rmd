...
# Introduction
One of the ultimate goals in systems biology is to elucidate the genotype-phenotype relationship in cellular systems [1]. Integrated 'omics' approaches have received particular attention. Most omics analyses monitor the levels of target molecules like transcripts and metabolites. In this context, enrichment analysis approaches can be combined with pathway analysis to evaluate whether a particular molecular group is significantly over-represented, for example Gene Set Enrichment Analysis (GSEA) [2-3]. In metabolomics, one of promising approaches is [Metabolite Set Enrichment Analysis (MSEA)](https://academic.oup.com/nar/article-lookup/doi/10.1093/nar/gkq329) [4]. 
