...
test_that("MSEA columns for plot functions", {
  ...
  expect_equal(as.character(foo$from[1]), "SMP00007")
  expect_equal(as.character(foo$to[1]), "SMP00351")
  expect_equal(as.character(foo$shared[1]), "C00001 C00003 C00004 C00005 C00006 C00007 C00010 C00011 C00014 C00016 C00018 C00024 C00025 C00026 C00027 C00038 C00049 C00061 C00070 C00076 C00080 C00099 C00106 C00135 C00222 C00386 C00429 C00864 C00986 C01152 C01262 C02642 C05665")
